...
Table \ref{tab:depth-data-example} shows the values of these arrays
...
\caption{Average time for computing node pointers in root-to-leaf traversals
	...
	level data.}
\end{figure}
As evident in figure \ref{fig:veb-drilldown-speed}, using precomputed level data
