...
\def\Abstract{%
	...
	their performance in main memory. Our survey includes both well-known
	data structures (\mbox{B-trees}, red-black trees, splay trees and
	hashing) and more exotic approaches ($k$-splay trees and $k$-forests).
}
