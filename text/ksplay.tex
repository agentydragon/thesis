...
child[sibling distance=2cm] { node [ks_node] {15 \nodepart{two} 21}
	child[sibling distance=0.7cm] { node {a} }
	child[sibling distance=0.7cm] { node {b} }
	child[sibling distance=0.7cm] { node {c} }
}
child[sibling distance=2cm] { node [ks_node] {60 \nodepart{two} 64}
	child[sibling distance=0.7cm] { node {d} }
	child[sibling distance=0.7cm] { node {e} }
	child[sibling distance=0.7cm] { node {f} }
}
child[sibling distance=2cm] { node [ks_node] {80 \nodepart{two} 95}
	child[sibling distance=0.7cm] { node {g} }
	child[sibling distance=0.7cm] { node {h} }
	child[sibling distance=0.7cm] { node {i} }
};
