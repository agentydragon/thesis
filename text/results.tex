...
We compared our cache-aware 2-3-4 trees to simpler, cache-unaware dictiories:
...
Red-black trees ended up slightly slower than our cache-aware 2-3-4 trees.
...
to 2-3-4 trees on both random uniform access patterns and modestly large working
...
outperfrom. As expected, splay trees are somewhat slower than 2-3-4 trees on
...
\caption{Benchmarks of self-adjusting structures.
	2-3-4 trees are included for reference.}
...
$k$-forests were slow both backed by 2-3-4 trees and by cache-oblivious B-trees.
...
Interestingly, red-black trees outperformed cache-aware 2-3-4 trees
even through our synthetic experiments ran slightly faster on 2-3-4 trees.
One possible explanation is the presence of \texttt{Delete}s in the recording --
we did not perform any experiment to measure their speed.
...
standard \mbox{2-3-4 trees}. Splay trees were surprisingly fast. One factor that
