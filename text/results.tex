...
\begin{subfigure}[t]{0.45\textwidth}
	...
	\caption{Random successful \textsc{Find}s}
\end{subfigure}
~
\begin{subfigure}[t]{0.45\textwidth}
...
%	      dict_btree:     25 884 347 926 ns
	...
	Cache-oblivious B-tree & $20.69\,\text{s}$ & $20.58\,\text{s}$ \\
	\hline
	Splay tree & $6.03\,\text{s}$ & $6.65\,\text{s}$ \\
	\hline
	$k$-splay tree & $41.69\,\text{s}$ & $44.72\,\text{s}$ \\
	\hline
	B-tree & $22.68\,\text{s}$ & $25.89\,\text{s}$ \\
	\hline
\end{tabular}
