...
A desirable property of Peano curves is that their mapping preserves
adjacency: neighbours from the one-dimensional space are mapped
to neighbours in the two-dimensional space.
