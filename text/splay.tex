...
until $x$ becomes the root. Up to left-right symmetry, there are three
cases of splaying steps:
...
\path[->] (Before.east) edge node [above] {zig} (After.west);
...
\node [draw=red, fit=(g-a) (x-a) (p-a) (hunk1-a) (hunk2-a) (hunk3-a) (hunk4-a)]
	(After) {};
\path[->] (Before.east) edge node [above] {zig-zig} (After.west);
\end{tikzpicture}
